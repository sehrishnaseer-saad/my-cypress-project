...
const runImageDiffAfterScreenshot = async (screenshotConfig) => {
    ...
    if (screenshotConfig.specName) {
        ...
        cleanedScreenshotPath = cleanedScreenshotPath.replace(node_path_1.default.normalize(screenshotConfig.specName), '');
    }
    ...
    const dirName = node_path_1.default.dirname(cleanedScreenshotPath);
